...
function down () {
    if (player_y <= 500) {
        player_y = player_y + block_image_height;
        console.log("block_image_height =" + block_image_height);
        console.log("when down arrow is pressed =" + player_y );
        canvas.remove(player_object);
        player_update();
    }
}
...
function left () {
    if (player_x > 0) {
        ...
        console.log("when left arrow is pressed =" + player_y );
        canvas.remove(player_object);
        player_update();
    }
}
...
function right () {
    if (player_x <= 850) {
        player_x = player_x + block_image_width;
        console.log("block_image_width =" + block_image_width);
        console.log("when right arrow is pressed arrow is pressed =" + player_y );
        canvas.remove(player_object);
        player_update();
    }
}
